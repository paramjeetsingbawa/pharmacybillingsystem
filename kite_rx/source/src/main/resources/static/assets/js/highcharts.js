...
$(function(e){
  'use strict';
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#ecb403', '#64E572' ,'#24CBE5', '#17B794', '#172f71' ],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#ecb403', '#24CBE5', '#172f71' , '#17B794', '#ff5c75' ],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	colors: ['#17B794', '#172f71', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
