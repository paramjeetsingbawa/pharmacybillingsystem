    ...
    $.ajax({
        ...
        if (data) {
            ...
            $.each(summary, function (i, theItem) {
                ...
                if ((!theItem["cusMobile"]) || theItem["cusMobile"] === "") {
                    row.append($("<td id='" + rowid + "_cusMobile" + "'>").text("---"));
                } else {
                    row.append($("<td id='" + rowid + "_cusMobile" + "'>").text(theItem["cusMobile"]));
                }

                if ((!theItem["prescriberName"]) || theItem["prescriberName"] === "") {
                    row.append($("<td id='" + rowid + "_prescriberName" + "'>").text("---"));
                } else {
                    row.append($("<td id='" + rowid + "_prescriberName" + "'>").text(theItem["prescriberName"]));
                }
                if ((!theItem["prescriptionDate"]) || theItem["prescriptionDate"] === "") {
                    row.append($("<td id='" + rowid + "_prescriptionDate" + "'>").text("---"));
                } else {
                    row.append($("<td id='" + rowid + "_prescriptionDate" + "'>").text(theItem["prescriptionDate"]));
                }

                row.append($("<td id='" + rowid + "_billNo" + "'>").text(theItem["billNo"]));

                row.append($("<td id='" + rowid + "_billDate" + "'>").text(theItem["billDate"]));
                row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(parseFloat(theItem["totalAmountPaid"]).toFixed(2)));
                ...
                $.ajax({
                    ...
                    if (data) {
                        ...
                        $.each(summary, function (i, theItem) {
                            ...
                            var amtPerUnit = parseFloat(theItem["amountPerUnit"]);
                            var totalCgstTaxPer = parseFloat(theItem["cgst"]);

                            if (totalCgstTaxPer > 0.00) {
                                var c2 = ((parseFloat(amtPerUnit) * parseFloat(totalCgstTaxPer)) / 100).toFixed(4);
                                row.append($("<td id='" + rowid + "_cgst" + "'>").text(c2));
                            } else {
                                var c2 = 0.0;
                                row.append($("<td id='" + rowid + "_cgst" + "'>").text(c2));
                            }

                            var totalSgstTaxPer = parseFloat(theItem["sgst"]);

                            if (totalSgstTaxPer > 0.00) {
                                var c2 = ((parseFloat(amtPerUnit) * parseFloat(totalSgstTaxPer)) / 100).toFixed(4);
                                row.append($("<td id='" + rowid + "_sgst" + "'>").text(c2));
                            } else {
                                var c2 = 0.0;
                                row.append($("<td id='" + rowid + "_sgst" + "'>").text(c2));
                            }

                            document.getElementById("taxAmountPerUnit").value = (parseFloat(amtPerUnit) - ((parseFloat(amtPerUnit) * parseFloat(totalCgstTaxPer)) / 100 + (parseFloat(amtPerUnit) * parseFloat(totalSgstTaxPer)) / 100)).toFixed(4);
...
//                            row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
//                            row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                        row.append($("<td id='" + rowid + "_totalAmountPaid_a1" + "' style='font-weight:500;'>").text("Additional Discount"));
                        var c = parseFloat(additionalDiscount).toFixed(0);
                        row.append($("<td id='" + rowid + "_totalAmountPaid_a11" + "' align='right' style='font-weight:500;'>").text("" + c + ""));
                        $("#tabBpelVariableListBody").append(row);
...
//                             row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
//                             row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                        row.append($("<td id='" + rowid + "_totalAmountPaid_a2" + "' style='font-weight:700;font-size:20px;color:green;'>").text("Grand Total (Rs)"));
                        row.append($("<td id='" + rowid + "_totalAmountPaid_a22" + "' style='font-weight:700;font-size:20px;color:green;' align='right'>").text(totalPrice.toFixed(2)));
                        $("#tabBpelVariableListBody").append(row);
...
function openBillOfPay() {
    var location = window.location.href;
    var locationA = location.split("?billNo=");
    window.open("/AvonMedicalService/billOfSupply.html?billNo=" + locationA[1], "_blank");
}

function getInvoice(pageRef) {
    ...
    $.ajax({
        ...
        if (data) {
            ...
            if (summary.length === 0) {
                swal({title: "Not Found!", text: "Sales Data Not Found, May be deleted manually?"});
            }
            ...
            var additionalDiscount = 0.0;
            var totalProducts = 0;
            var totalRetrunProductAmount = 0.0;
            $.each(summary, function (i, theItem) {
                ...
                row.append($("<td id='" + rowid + "index" + "'>").text(index++));
                row.append($("<td id='" + rowid + "productName" + "'>").text(theItem["productName"]));
                row.append($("<td id='" + rowid + "batchNumber" + "'>").text(theItem["batchNumber"]));
                if (pageRef === 2) {
                    if (theItem["companyName"] !== null && theItem["companyName"] !== '' && theItem["companyName"] !== 'null') {
                        row.append($("<td id='" + rowid + "companyName" + "'>").text(theItem["companyName"]));
                    } else {
                        row.append($("<td id='" + rowid + "companyName" + "'>").text("---"));
                    }
                }
                row.append($("<td id='" + rowid + "packing" + "'>").text(theItem["packing"]));
                row.append($("<td id='" + rowid + "expiryDate" + "'>").text(theItem["expiryDate"]));
                if (document.getElementById("paymentTypeM")) {
                    document.getElementById("paymentTypeM").innerHTML = theItem["paymentType"]
                }
                try {
                    document.getElementById("billPrintNo").innerHTML = theItem["billPrintNo"];
                    document.getElementById("billPrintDate").innerHTML = theItem["billDate"];
                    document.getElementById("creditStatus").innerHTML = theItem["creditStatus"];

                    document.getElementById("paymentType").innerHTML = theItem["paymentType"];

                } catch (err) {

                }
                if (theItem["creditStatus"] !== null && theItem["creditStatus"] === 'PAYMENT-PENDING') {
                    try {
                        if (document.getElementById("creditStatus")) {
                            document.getElementById("creditStatus").style.color = 'red';
                        }

                        if (document.getElementById("paymentType")) {
                            document.getElementById("paymentType").style.color = 'red';
                        }

                        if (document.getElementById("creditAmount")) {
                            document.getElementById("creditAmount").style.color = 'red';
                        }

                        if (theItem["creditAmount"] && theItem["creditAmount"] !== '') {
                            document.getElementById("creditAmount").innerHTML = 'CREDIT AMOUNT : ' + theItem["creditAmount"];
                        } else {
                            document.getElementById("creditAmount").innerHTML = 'CREDIT AMOUNT : _______________';
                        }
                    } catch (Err) {

                    }

                } else if (theItem["creditStatus"] !== null && theItem["creditStatus"] === 'PAID') {
                    try {
                        document.getElementById("creditStatus").style.color = 'green';
                        document.getElementById("paymentType").style.color = 'green';
                    } catch (Err) {
                ...
                // row.append($("<td id='" + rowid + "_cusMobile" + "'>").text(theItem["productId"]));
                if (pageRef === 2) {
                    row.append($("<td id='" + rowid + "_totalAmountPaid" + "'  style='font-weight:700;font-size:12px;' align='right'>").text(theItem["mrp"]));
                    row.append($("<td id='" + rowid + "_billDate" + "'  style='font-weight:700;font-size:12px;' align='right'>").text(theItem["quantityPurchased"]));
                    row.append($("<td id='" + rowid + "_totalAmountPaid" + "'  style='font-weight:700;font-size:12px;' align='right'>").text(theItem["amountPerUnit"]));
                    var amtPerUnit = parseFloat(theItem["amount"]);
                    var totalCgstTaxPer = parseFloat(theItem["cgst"]);
                    var totalSgstTaxPer = parseFloat(theItem["sgst"]);

                    row.append($("<td id='" + rowid + "_tt" + "'  style='font-weight:700;font-size:12px;' align='right'>").text((parseFloat(amtPerUnit) - ((parseFloat(amtPerUnit) * parseFloat(totalCgstTaxPer)) / 100 + (parseFloat(amtPerUnit) * parseFloat(totalSgstTaxPer)) / 100)).toFixed(4)));

                    totalTaxable = totalTaxable + parseFloat((parseFloat(amtPerUnit) - ((parseFloat(amtPerUnit) * parseFloat(totalCgstTaxPer)) / 100 + (parseFloat(amtPerUnit) * parseFloat(totalSgstTaxPer)) / 100)).toFixed(4));

                    if (totalCgstTaxPer > 0.00) {
                        var c2 = ((parseFloat(amtPerUnit) * parseFloat(totalCgstTaxPer)) / 100).toFixed(2);
                        row.append($("<td id='" + rowid + "_cgst" + "' style='font-weight:700;font-size:12px;' align='right'>").text(c2 + " (" + parseFloat(theItem["cgst"]) + "%)"));
                        totalCGST = totalCGST + parseFloat(c2);
                    } else {
                        var c2 = 0.0;
                        row.append($("<td id='" + rowid + "_cgst" + "' style='font-weight:700;font-size:12px;' align='right'>").text(c2 + " (" + parseFloat(theItem["cgst"]) + "%)"));
                        totalCGST = totalCGST + parseFloat(c2);
                    ...
                    if (totalSgstTaxPer > 0.00) {
                        var c2 = ((parseFloat(amtPerUnit) * parseFloat(totalSgstTaxPer)) / 100).toFixed(2);
                        row.append($("<td id='" + rowid + "_sgst" + "' style='font-weight:700;font-size:12px;' align='right'>").text(c2 + " (" + parseFloat(theItem["sgst"]) + "%)"));
                        totalSGST = totalSGST + parseFloat(c2);
                    } else {
                        var c2 = 0.0;
                        row.append($("<td id='" + rowid + "_sgst" + "' style='font-weight:700;font-size:12px;' align='right'>").text(c2 + " (" + parseFloat(theItem["sgst"]) + "%)"));
                        totalSGST = totalSGST + parseFloat(c2);
                    ...
                    var c = parseFloat(theItem["quantityPurchased"]) * parseFloat(theItem["mrp"]);

                    row.append($("<td id='" + rowid + "_totalAmountPaid" + "' style='font-weight:700;font-size:12px;' align='right'>")
                            .text(parseFloat(theItem["amount"]).toFixed(2)));
                } else {
                    row.append($("<td id='" + rowid + "_totalAmountPaid" + "'  style='font-weight:700;font-size:12px;' align='right'>").text(theItem["mrp"]));
                    row.append($("<td id='" + rowid + "_billDate" + "'  style='font-weight:700;font-size:12px;' align='right'>").text(theItem["quantityPurchased"]));
                    row.append($("<td id='" + rowid + "_totalAmountPaid" + "'  style='font-weight:700;font-size:12px;' align='right'>").text(theItem["amountPerUnit"]));
                    ...
                    row.append($("<td id='" + rowid + "_tt" + "'  style='font-weight:700;font-size:12px;' align='right'>").text((parseFloat(amtPerUnit) - ((parseFloat(amtPerUnit) * parseFloat(totalCgstTaxPer)) / 100 + (parseFloat(amtPerUnit) * parseFloat(totalSgstTaxPer)) / 100)).toFixed(2)));

                    totalTaxable = totalTaxable + parseFloat((parseFloat(amtPerUnit) - ((parseFloat(amtPerUnit) * parseFloat(totalCgstTaxPer)) / 100 + (parseFloat(amtPerUnit) * parseFloat(totalSgstTaxPer)) / 100)).toFixed(4));

                    if (totalCgstTaxPer > 0.00) {
                        var c2 = ((parseFloat(amtPerUnit) * parseFloat(totalCgstTaxPer)) / 100).toFixed(2);
                        row.append($("<td id='" + rowid + "_cgst" + "' style='font-weight:700;font-size:12px;' align='right'>").text(c2));
                        totalCGST = totalCGST + parseFloat(c2);
                    } else {
                        var c2 = 0.0;
                        row.append($("<td id='" + rowid + "_cgst" + "' style='font-weight:700;font-size:12px;' align='right'>").text(c2));
                    ...
                    if (totalSgstTaxPer > 0.00) {
                        var c2 = ((parseFloat(amtPerUnit) * parseFloat(totalSgstTaxPer)) / 100).toFixed(2);
                        row.append($("<td id='" + rowid + "_sgst" + "' style='font-weight:700;font-size:12px;' align='right'>").text(c2));
                        totalSGST = totalSGST + parseFloat(c2);
                    } else {
                        var c2 = 0.0;
                        row.append($("<td id='" + rowid + "_sgst" + "' style='font-weight:700;font-size:12px;' align='right'>").text(c2));
                ...
                var am = parseFloat(theItem["amount"]);

                if (am < 0) {
                    //Returned Cased
                    totalRetrunProductAmount = totalRetrunProductAmount + Math.abs(am);
                }
                ...
                //if( am < 0 ){
                totalUnitPrice = totalUnitPrice + am;
...
//                            totalIGST = totalIGST + ((temp * parseFloat(theItem["igst"])) / 100 );
                ...
                if (document.getElementById("custname")) {
                    if (theItem["customerName"] !== '' && theItem["customerName"] !== null) {
                        document.getElementById("custname").innerHTML = theItem["customerName"];
                    } else {
                        document.getElementById("custname").innerHTML = "____________________";
                    }
                }

                if (document.getElementById("prescribername")) {


                    if (theItem["prescriberName"] !== '' && theItem["prescriberName"] !== null) {
                        document.getElementById("prescribername").innerHTML = theItem["prescriberName"];
                    } else {
                        document.getElementById("prescribername").innerHTML = "____________________";
                    }
                }
                ...
                if (document.getElementById("custmobile")) {
                    ...
                    if (theItem["customerContact"] !== '' && theItem["customerContact"] !== null) {
                        document.getElementById("custmobile").innerHTML = theItem["customerContact"];
                    } else {
                        document.getElementById("custmobile").innerHTML = "____________________";
                    }
                }
                
                if (document.getElementById("custdlno2")) {
                    document.getElementById("custdlno2").innerHTML = "____________________";
                }
                
                if (document.getElementById("custGSTTIN")) {
                    document.getElementById("custGSTTIN").innerHTML = "____________________";
                }

                if (document.getElementById("prescriptionDate")) {


                    if (theItem["prescriptionDate"] !== '' && theItem["prescriptionDate"] !== null) {
                        document.getElementById("prescriptionDate").innerHTML = theItem["prescriptionDate"];
                    } else {
                        document.getElementById("prescriptionDate").innerHTML = "____________________";
                    }
                ...
                if (document.getElementById("custaddress")) {
                    ...
                    if (theItem["customerAddress"] !== '' && theItem["customerAddress"] !== null) {
                        document.getElementById("custaddress").innerHTML = theItem["customerAddress"];
                    } else {
                        document.getElementById("custaddress").innerHTML = "____________________";
                    }
                }
                ...
                if (document.getElementById("invoiceDate")) {
                    ...
                    if (theItem["createdAt"] !== '' && theItem["createdAt"] !== null) {
                        document.getElementById("invoiceDate").innerHTML = theItem["createdAt"];
                    } else {
                        document.getElementById("invoiceDate").innerHTML = "[NOT FOUND]";
                    }
            ...
            if (document.getElementById("invoicenumber2")) {
                document.getElementById("invoicenumber2").innerHTML = totalProducts;
            }

            totalPrice = totalUnitPrice - parseFloat(additionalDiscount);
...
//                            row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                ...
                row.append($("<td id='" + rowid + "_totalAmountPaid_a0" + "' style='font-weight:700;font-size:12px;'>").text("TOTAL TAXABLE AMOUNT"));
                row.append($("<td id='" + rowid + "_totalAmountPaid_a00" + "' align='right' style='font-weight:700;font-size:12px;'>").text(totalTaxable));
                $("#tabBpelVariableListBody").append(row);
...
//                            row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                ...
                row.append($("<td id='" + rowid + "_totalAmountPaid_a0" + "' style='font-weight:700;font-size:12px;'>").text("TOTAL CGST"));
                row.append($("<td id='" + rowid + "_totalAmountPaid_a00" + "' align='right' style='font-weight:700;font-size:12px;'>").text(totalCGST.toFixed(2)));
                $("#tabBpelVariableListBody").append(row);
...
//                            row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                ...
                row.append($("<td id='" + rowid + "_totalAmountPaid_a0" + "' style='font-weight:700;font-size:12px;'>").text("TOTAL SGST"));
                row.append($("<td id='" + rowid + "_totalAmountPaid_a00" + "' align='right' style='font-weight:700;font-size:12px;'>").text(totalSGST.toFixed(2)));
                $("#tabBpelVariableListBody").append(row);
...
//                            row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                ...
                row.append($("<td id='" + rowid + "_totalAmountPaid_a0" + "' style='font-weight:700;font-size:12px;'>").text("SUB TOTAL"));
                row.append($("<td id='" + rowid + "_totalAmountPaid_a00" + "' align='right' style='font-weight:700;font-size:12px;'>").text(totalUnitPrice.toFixed(2)));
                $("#tabBpelVariableListBody").append(row);
...
//                            row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                ...
                row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                row.append($("<td id='" + rowid + "_totalAmountPaid_a1" + "' style='font-weight:700;font-size:12px;'>").text("DISCOUNT"));
                var c = parseFloat(additionalDiscount).toFixed(0);
                row.append($("<td id='" + rowid + "_totalAmountPaid_a11" + "' align='right' style='font-weight:700;font-size:12px;'>").text(parseFloat(c).toFixed(2)));
                $("#tabBpelVariableListBody").append(row);

                rowid = "row_Grand_total";
...
//                             row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                ...
                row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                row.append($("<td id='" + rowid + "_totalAmountPaid" + "'>").text(""));
                row.append($("<td id='" + rowid + "_totalAmountPaid_a2" + "' style='font-weight:700;font-size:12px;color:green;'>").text("GRAND TOTAL"));
                row.append($("<td id='" + rowid + "_totalAmountPaid_a22" + "' style='font-weight:700;font-size:12px;color:green;' align='right'>").text(totalPrice.toFixed(2)));
                $("#tabBpelVariableListBody").append(row);
            } else {
                var c = parseFloat(additionalDiscount).toFixed(0);
                ...
                //+ "&nbsp;&nbsp;<br />Total CGST:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" 
                //+ totalCGST.toFixed(2) + "&nbsp;&nbsp;<br />Total SGST:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" 
                //+ totalSGST.toFixed(2) + "&nbsp;&nbsp;<br />Sub Total:&nbsp;&nbsp;&nbsp;&nbsp;" 
                //+ totalUnitPrice.toFixed(2) + "&nbsp;&nbsp;<br />Discount: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                //       " + parseFloat(c).toFixed(2) + "&nbsp;&nbsp;<br /> Grand Total: &nbsp;&nbsp; " + totalPrice.toFixed(2) + "&nbsp;&nbsp;";
                document.getElementById("totalTaxableTdFinal").innerHTML = totalTaxable.toFixed(2);
                document.getElementById("totalCGSTTdFinal").innerHTML = totalCGST.toFixed(2);
                document.getElementById("totalSGSTTdFinal").innerHTML = totalSGST.toFixed(2);
                document.getElementById("totalsubTotalTdFinal").innerHTML = totalUnitPrice.toFixed(2);
                document.getElementById("totalDiscountTdFinal").innerHTML = parseFloat(c).toFixed(2);
                document.getElementById("totalGrandTotalTdFinal").innerHTML = totalPrice.toFixed(2);
            }
...
function editSalesData() {
    if (confirmedEdit === 0) {
        ...
        document.getElementById("custmobileTxt").style.display = "block";
        document.getElementById("custnameTxt").style.display = "block";
        document.getElementById("prescriberNameTxt").style.display = "block";
        document.getElementById("prescriptionWrittenDateTxt").style.display = "block";

        //creditStatusTxt
        document.getElementById("paymentTypeTxt").value = document.getElementById("paymentType").innerHTML;
        document.getElementById("custmobileTxt").value = document.getElementById("custmobile").innerHTML;
        document.getElementById("custnameTxt").value = document.getElementById("custname").innerHTML;
        document.getElementById("creditStatusTxt").value = document.getElementById("creditStatus").innerHTML;
        document.getElementById("prescriberNameTxt").value = document.getElementById("prescribername").innerHTML;
        document.getElementById("prescriptionWrittenDateTxt").value = document.getElementById("prescriptionDate").innerHTML;

        document.getElementById("creditStatusTxt").style.display = "block";
        document.getElementById("statusSpn").style.display = "block";

        if (document.getElementById("creditAmount") && document.getElementById("creditStatus").innerHTML !== 'PAID') {
            //if()
            document.getElementById("creditAmountTxt").value = document.getElementById("creditAmount").innerHTML.split("CREDIT AMOUNT :")[1].trim();
            if (document.getElementById("creditAmountTxt").value === '_______________') {
                document.getElementById("creditAmountTxt").value = '0';
            }
            document.getElementById("creditAmountTxt").style.display = "block";
            document.getElementById("creditSpn").style.display = "block";

            document.getElementById("paymentAmountTxt").value = document.getElementById("creditAmount").innerHTML.split("CREDIT AMOUNT :")[1].trim();
            if (document.getElementById("paymentAmountTxt").value === '_______________') {
                document.getElementById("paymentAmountTxt").value = '0';
            }
            document.getElementById("paymentAmountTxt").style.display = "block";
            document.getElementById("payRecieve").style.display = "block";

            document.getElementById("paymentAmountTxt1").style.display = "block";
            document.getElementById("payRecieve1").style.display = "block";

            document.getElementById("paymentAmountTxt2").style.display = "block";
            document.getElementById("payRecieve2").style.display = "block";

            document.getElementById("paymentAmountTxt3").style.display = "block";
            document.getElementById("payRecieve3").style.display = "block";
        }

        document.getElementById("paymentType").style.display = "none";
        document.getElementById("custmobile").style.display = "none";
        document.getElementById("custname").style.display = "none";
        document.getElementById("p3").innerHTML = "Confirm Edit";
        confirmedEdit = 1;
    } else {
        confirmedEdit = 1;
        var location = window.location.href;
        ...
        var urlString = "/AvonMedicalService/rest/CoreService/updateCustomerBillingDetail?";
        urlString += "&billNo=" + locationA[1];
        urlString += "&custNameFilter=" + document.getElementById("custnameTxt").value;
        urlString += "&custMobileFilter=" + document.getElementById("custmobileTxt").value;
        urlString += "&paymentType=" + document.getElementById("paymentTypeTxt").value;
        urlString += "&creditAmount=" + document.getElementById("creditAmountTxt").value;
        urlString += "&paymentAmount=" + document.getElementById("paymentAmountTxt").value;
        urlString += "&paymentAmount1=" + document.getElementById("paymentAmountTxt1").value;
        urlString += "&paymentAmount2=" + document.getElementById("paymentAmountTxt2").value;
        urlString += "&paymentAmount3=" + document.getElementById("paymentAmountTxt3").value;
        urlString += "&prescriberNameFilter=" + document.getElementById("prescriberNameTxt").value;
        urlString += "&prescriptionDate=" + document.getElementById("prescriptionWrittenDateTxt").value;


        var continueEdit = 0;
        if (document.getElementById("creditAmountTxt").value ===
                document.getElementById("paymentAmountTxt").value) {
            if (parseFloat(document.getElementById("creditAmountTxt").value) > 0) {
                swal({
                    title: "Want to change status to paid?",
                    text: "As the credit amount and payment recieved is exactly same, you can close this credit invoice!",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonClass: "btn-danger",
                    confirmButtonText: "Yes, Change status to paid",
                    cancelButtonText: "No, just update record",
                    closeOnConfirm: false,
                    closeOnCancel: false
                },
                        function (isConfirm) {
                            if (isConfirm) {
                                urlString += "&creditStatus=PAID";
                            } else {
                                urlString += "&creditStatus=" + document.getElementById("creditStatusTxt").value;
                            }
                            ...
                            $.ajax({
                                ...
                                swal({title: "Updated", text: "Sales Data Updated Successfully."}, function () {
                                    window.location.reload();
                                });

                                document.getElementById("paymentType").style.display = "block";
                                document.getElementById("custmobile").style.display = "block";
                                document.getElementById("custname").style.display = "block";

                                document.getElementById("paymentType").innerHTML = document.getElementById("paymentTypeTxt").value;
                                document.getElementById("custmobile").innerHTML = document.getElementById("custmobileTxt").value;
                                document.getElementById("custname").innerHTML = document.getElementById("custnameTxt").value;

                                document.getElementById("paymentTypeTxt").style.display = "none";
                                document.getElementById("custmobileTxt").style.display = "none";
                                document.getElementById("custnameTxt").style.display = "none";
                                document.getElementById("creditAmountTxt").style.display = "none";
                                document.getElementById("creditStatusTxt").style.display = "none";

                                document.getElementById("creditSpn").style.display = "none";
                                document.getElementById("payRecieve").style.display = "none";
                                document.getElementById("statusSpn").style.display = "none";

                                document.getElementById("p3").innerHTML = "Edit Sales Record";
                                confirmedEdit = 0;
                            });
    ...
    //document.getElementById("creditAmount").style.display = "none";
}
    ...
    swal({
        ...
        closeOnConfirm: false
            ...
            function () {
                ...
                var locationA = location.split("?billNo=")
                var urlString = "/AvonMedicalService/rest/CoreService/deleteSalesData?billNo=" + locationA[1];
                $.ajax({
                    url: urlString
                }).then(function (data) {
                    if (data === true || data === 'true') {
                        swal({title: "Deleted", text: "Sales Data Deleted"});
                    } else {
                        swal({title: "Not Deleted", text: "Sales Data Not Deleted!!"});
                    }
                });
