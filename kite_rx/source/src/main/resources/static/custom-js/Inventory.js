...
$("#quantityFilterTxt").bind('keypress', function (e) {
    if (e.which == 13) {
        getBpelInstances();
    }
});
...
function generateBill() {
    ...
    document.getElementById('billNo').innerHTML = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (c) {
...
function getBpelInstances2(sortField, sortOrder) {
    var filterset = 0;
    $('#myModal').modal('show');

    if (document.getElementById("bpelInstSummayTabBody32")) {
        document.getElementById("bpelInstSummayTabBody32").innerHTML = "";
    }
    ...
    var urlString = "/AvonMedicalService/rest/CoreService/getAboutToExpireProductDetail?";
    ...
    $.ajax({
        ...
        if (data) {
            ...
            $.each(summary, function (i, theItem) {
                ...
                var rowid = theItem.productId + "_2";
                var row;
                row = $("<tr id='" + rowid + "'></tr>");
                ...
                if (!parseInt(theItem["vat"])) {
                    row.append($("<td id='" + rowid + "_vat" + "'>").text("0%"));
                } else {
            ...
            var seqno = 0;
            //Click on testInst table
            $('#testInst2').on('click', 'td', function () {
                document.getElementById("addQuantityForBillingTxt").value = "";
                var trackingWindow = document.getElementById('myMessageTrackingWindow');
                //trackingWindow.style.width = "0%";
                trackingWindow.style.height = "0%";
                ...
                if (document.getElementById(trid + "_packing").innerHTML.indexOf(" ") > 0) {
                    packing = document.getElementById(trid + "_packing").innerHTML.substring(0, document.getElementById(trid + "_packing").innerHTML.indexOf(" "));
                } else {
                    packing = document.getElementById(trid + "_packing").innerHTML;
                }
                var free = document.getElementById(trid + "_free").innerHTML.substring(0, document.getElementById(trid + "_free").innerHTML.indexOf(" "));
                document.getElementById("bpelName").innerHTML = document.getElementById(trid + "_productName").innerHTML;
                document.getElementById("quantity").innerHTML = (document.getElementById(trid + "_quantityInShop").innerHTML) * (packing + free);
                ...
                document.getElementById("amountPerUnit").value = (parseFloat(a) / parseFloat(packing)) + parseFloat(a * (v / 100));
...
function getBpelInstances1(sortField, sortOrder) {
    var filterset = 0;
    $('#myModal').modal('show');

    if (document.getElementById("bpelInstSummayTabBody31")) {
        document.getElementById("bpelInstSummayTabBody31").innerHTML = "";
    }

    var urlString = "/AvonMedicalService/rest/CoreService/getExpireProductDetail?";
    filterset = 1;
    ...
    $.ajax({
        ...
        if (data) {
            ...
            $.each(summary, function (i, theItem) {
                ...
                var rowid = theItem.productId + "_1";
                var row;
                row = $("<tr id='" + rowid + "'></tr>");
            ...
            var seqno = 0;
            //Click on testInst table
            $('#testInst1').on('click', 'td', function () {
                document.getElementById("addQuantityForBillingTxt").value = "";
                var trackingWindow = document.getElementById('myMessageTrackingWindow');
                //trackingWindow.style.width = "0%";
                trackingWindow.style.height = "0%";
