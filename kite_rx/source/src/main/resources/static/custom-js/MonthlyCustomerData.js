...
$("#custNameFilterTxt").on('focus', function (e) {
...
function getCustomerInstances(isExported) {
    ...
    var urlString = "/AvonMedicalService/rest/LadgerService/getCustomers?maxrecord=50&pageNo=" + pageNo + "&pageSize=" + pageSize;
    var someFilterSet = false;
    var statusFilterTxtValue = document.getElementById("custNameFilterTxt");
    if (statusFilterTxtValue) {
        if ($.trim(statusFilterTxtValue.value) != "") {
            urlString += "&name=" + statusFilterTxtValue.value;
            someFilterSet = true;
        }
        //statusFilterTxtValue.value = "";
    }
    ...
    if (bpelFilterTxtValue) {
        if ($.trim(bpelFilterTxtValue.value) != "") {
            urlString += "&mobile=" + bpelFilterTxtValue.value;
            someFilterSet = true;
        }
        //bpelFilterTxtValue.value = "";
    }
    ...
    if (paymentTypeTxt) {
        if ($.trim(paymentTypeTxt.value) != "") {
            urlString += "&isCreditSearch=" + paymentTypeTxt.value;
            someFilterSet = true;
        }
        //bpelFilterTxtValue.value = "";
    }
    ...
    var isCreditSearch = 0;
    if (!someFilterSet) {
        var location = window.location.href;
        try {
            var locationA = location.split("?custNameFilter=");
            if (locationA[1] && locationA[1] !== '' && locationA[1] !== 'undefined') {
                urlString += "&name=" + locationA[1];
                document.getElementById("custNameFilterTxt").value = locationA[1];
                someFilterSet = true;
            } else {

            }

            var locationA = location.split("?isCreditSearch=");
            if (locationA[1] && locationA[1] !== '' && locationA[1] !== 'undefined') {
                urlString += "&isCreditSearch=" + locationA[1];
            ...
            var locationA = location.split("?onlyPending=");
            if (locationA[1] && locationA[1] !== '' && locationA[1] !== 'undefined') {
                urlString += "&onlyPending=" + locationA[1];
    ...
    if (!someFilterSet) {
        ...
        document.getElementById("filterSpn").innerHTML = " For Selected filter ";
    }


    if (onlyPending === 1) {

        urlString += "&onlyPending=1";
        someFilterSet = true;
    ...
    if (customerIDForBilling != 0) {
        urlString += "&id=" + customerIDForBilling;
    }
    ...
    $.ajax({
        ...
        if (data) {
            ...
            $.each(summary, function (i, theItem) {
                ...
                var row;
                var redColor = false;
                if (theItem["IS_CREDIT_ACCOUNT"] === '1') {
                    try {
                        var s = parseFloat(theItem["TOTAL_CREDIT_ASOFNOW"]);
                        if (s > 0) {
                            redColor = true;
                            row = $("<tr id='" + rowid + "' style='background-color:#ff2121;color:white;'></tr>");
                        } else if (s < 0) {
                            row = $("<tr id='" + rowid + "' style='background-color:#71bd1b;color:black;'></tr>");
                        } else {
                    ...
                    row = $("<tr id='" + rowid + "' style='background-color:#bdb76b;color:black;'></tr>");
                }

                row.append($("<td id='" + rowid + "_ID" + "'>").text(theItem["ID"]));

                if (isCreditSearch == 1) {
                    row.append($("<td id='" + rowid + "_IMG" + "'><img src='assets/images/faces/male/unknown.png' style='width:50px;height:50px;'/>"));
                } else {
                    row.append($("<td id='" + rowid + "_IMG" + "'><img src='assets/images/faces/male/unknown.png' style='width:50px;height:50px;'/>"));
                }
                if (!redColor) {
                    row.append($("<td id='" + rowid + "_NAME" + "'><a href='#' class='btn btn-link' style='color:#353635;font-weight:700;margin-left:-10px;'>" + theItem["NAME"] + "</a>"));
                } else {
                    row.append($("<td id='" + rowid + "_NAME" + "'><a href='#' class='btn btn-link' style='color:white;font-weight:700;margin-left:-10px;'>" + theItem["NAME"] + "</a>"));
                }

                if (theItem["MOBILE"] !== '' || theItem["MOBILE"] !== null) {
                    row.append($("<td id='" + rowid + "_MOBILE" + "'>").text(theItem["MOBILE"]));
                } else {
                    row.append($("<td id='" + rowid + "_MOBILE" + "'>").text("---"));
                }
                row.append($("<td id='" + rowid + "_ADDRESS" + "'>").text(theItem["ADDRESS"]));

                row.append($("<td id='" + rowid + "_EMAIL" + "'>").text(theItem["EMAIL"]));
                if (theItem["IS_CREDIT_ACCOUNT"] === '1') {
                    row.append($("<td id='" + rowid + "_IS_CREDIT_ACCOUNT" + "'>").text("CREDIT"));
                } else {
                    row.append($("<td id='" + rowid + "_IS_CREDIT_ACCOUNT" + "'>").text("NORMAL"));
                }
                row.append($("<td id='" + rowid + "_GSTIN" + "'>").text(theItem["GSTIN"]));
                row.append($("<td id='" + rowid + "_MAX_CREDIT_AMOUNT" + "' align='right'>").text(theItem["MAX_CREDIT_AMOUNT"]));
                row.append($("<td id='" + rowid + "_TOTAL_BILL_AMOUNT" + "' align='right'>").text(theItem["TOTAL_BILL_AMOUNT"]));
                row.append($("<td id='" + rowid + "_TOTAL_CREDIT_ASOFNOW" + "' align='right'>").text(theItem["TOTAL_CREDIT_ASOFNOW"]));
                row.append($("<td id='" + rowid + "_DEFAULT_DISCOUNT" + "' align='right'>").text(theItem["DEFAULT_DISCOUNT"]));
                ...
                /*var urlString2 = "/AvonMedicalService/rest/LadgerService/getCustomerImage?id=" + theItem.ID;
                 ...
                 document.getElementById("" + data.id + "_IMG").children[0].setAttribute("src", data.image);
                 document.getElementById("" + data.id + "_IMG").children[0].setAttribute("class", "avatar avatar-md brround");
                 
                 //alert(document.getElementById("" + data.id + "_IMG").children[0]);
                 } else {
                 document.getElementById("" + data.id + "_IMG").children[0].setAttribute("src", "assets/images/faces/male/unknown.png");
                 document.getElementById("" + data.id + "_IMG").children[0].setAttribute("style", "width:50px;height:50px;");
                 }
                 });*/
            ...
            $('#tabReportBody').on('click', 'td', function () {
                trid = $(this).attr('id');
...
function deleteCustomer() {
    ...
    if (confirm('Are you sure you want to delete this customer from database?')) {
        var urlString = "/AvonMedicalService/rest/LadgerService/quickDeleteCustomer?";
        urlString = urlString + "ID=" + document.getElementById("idAs").innerHTML;
        ...
        $.ajax({
            ...
            //alert(data);
            if (data && data === 'true') {
                swal({title: "Customer data deleted!", text: "server responded with success"});
            } else if (data && data === true) {
                swal({title: "Customer data deleted!", text: "server responded with success"});
            } else {
                swal({title: "Failed to delete!!", text: "server responded with error response code!"});
            }
...
function updateCustomer() {
    ...
    var urlString = "/AvonMedicalService/rest/LadgerService/quickUpdateCustomer?";

    urlString = urlString + "ID=" + document.getElementById("idAs").innerHTML;
    urlString = urlString + "&NAME=" + document.getElementById("customerNameUp").value;
    urlString = urlString + "&CONTACT_NAME=" + document.getElementById("contactNameUp").value;
    urlString = urlString + "&MOBILE=" + document.getElementById("phoneUp").value;
    urlString = urlString + "&ADDRESS=" + document.getElementById("addressUp").value;
    urlString = urlString + "&EMAIL=" + document.getElementById("emailUp").value;
    urlString = urlString + "&IS_CREDIT_ACCOUNT=" + document.getElementById("accountType").value;
    urlString = urlString + "&PHONE_1=" + document.getElementById("phone2Up").value;
    urlString = urlString + "&TTYPE=" + document.getElementById("customerType").value;
    urlString = urlString + "&GSTIN=" + document.getElementById("GSTIN").value;
    urlString = urlString + "&KEYWORDS=" + document.getElementById("KEYWORDS").value;
    urlString = urlString + "&FOLLOWUP_DATE_INTERVAL=" + "";
    urlString = urlString + "&TOTAL_BILL_AMOUNT=" + document.getElementById("totalBillUp").value;
    urlString = urlString + "&TOTAL_CREDIT_ASOFNOW=" + document.getElementById("totalCreditUp").value;
    urlString = urlString + "&paymentRsUp=" + document.getElementById("paymentRsUp").value;
    urlString = urlString + "&chequeNoUp=" + document.getElementById("chequeNoUp").value;
    urlString = urlString + "&cardNup=" + document.getElementById("cardNup").value;
    urlString = urlString + "&ddNoUp=" + document.getElementById("ddNoUp").value;


    urlString = urlString + "&DEFAULT_DISCOUNT=" + document.getElementById("defaultDiscountUp").value;
    urlString = urlString + "&MAX_CREDIT_AMOUNT=" + document.getElementById("maxCreditAllowedUp").value;
    ...
    $.ajax({
        ...
        //alert(data);
        var updateClear = false;
        if (data && data === 'true') {
            swal({title: "Customer data updated!", text: "server responded with success"});
            updateClear = true;
        } else if (data && data === true) {
            swal({title: "Customer data updated!", text: "server responded with success"});
            updateClear = true;
        } else {
            swal({title: "Failed update!!", text: "server responded with error response code!"});
        }
...
function addCustomer() {
    var urlString = "/AvonMedicalService/rest/LadgerService/quickAddCustomer?";
    urlString = urlString + "&NAME=" + document.getElementById("customerNameUp").value;
    urlString = urlString + "&CONTACT_NAME=" + document.getElementById("contactNameUp").value;
    urlString = urlString + "&MOBILE=" + document.getElementById("phoneUp").value;
    urlString = urlString + "&ADDRESS=" + document.getElementById("addressUp").value;
    ...
    urlString = urlString + "&KEYWORDS=" + document.getElementById("KEYWORDS").value;
    urlString = urlString + "&FOLLOWUP_DATE_INTERVAL=" + "";
    urlString = urlString + "&TOTAL_BILL_AMOUNT=" + "0";
    urlString = urlString + "&TOTAL_CREDIT_ASOFNOW=" + "0";
    urlString = urlString + "&DEFAULT_DISCOUNT=" + document.getElementById("defaultDiscountUp").value;
    urlString = urlString + "&MAX_CREDIT_AMOUNT=" + document.getElementById("maxCreditAllowedUp").value;
...
function addedCustomer(data) {

    //alert(data);
    if (data && data === 'true') {
        swal({title: "Customer data added!", text: "server responded with success"});
    } else if (data && data === true) {
        swal({title: "Customer data added!", text: "server responded with success"});
    } else {
        swal({title: "Failed to add!!", text: "server responded with error response code!"});
    }
...
$("#custNameForBillingTxt").bind('keyup', function (e) {
    ...
    try {
        ...
        //} else {
        //document.getElementById("custNameForBillingTxt").blur();
        //}
    } catch (err) {
    }
});
...
function getAllCustomerNames1(evnt) {
    ...
    $.ajax({
        ...
        if (data) {
            $.each(summary, function (i, theItem) {
                ...
                row.append($("<td id='" + theItem["ID"] + "' onclick='selectCustomer1(this)'><a href='#' style='font-weight:700;color: white;' >" + theItem["NAME"] + "</a>"));
...
function selectCustomer(ref) {
    ...
    document.getElementById("defaultDiscountUp").focus();

    //document.getElementById("faxNumber").style.border = '0.17em solid orange';
...
function fetchCreditReport(name) {
    var urlString = "/AvonMedicalService/rest/LadgerService/getCustomers?name=" + name;
    ...
    $.ajax({
        ...
        if (data) {
            $.each(summary, function (i, theItem) {
                var pa1 = "Pending Credit : " + theItem["TOTAL_CREDIT_ASOFNOW"];
                var pa2 = "Total Sale Amount : " + theItem["TOTAL_BILL_AMOUNT"];
                document.getElementById("creditReportDiv").innerHTML = pa1 + ", " + pa2 + " <a href='SaleReportV2.html?custNameFilter=" + name + "' target='_blank'>View Complete Report</a>";
            });
        }
    });
